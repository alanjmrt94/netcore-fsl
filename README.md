...
| Miembro | Descripción |
|---------|-------------|
| `FSL.Version` | Versión semántica (`1.0.6`) |
...
```csharp
Console.WriteLine(FSL.Version);        // "1.0.6"
Console.WriteLine(FSLVersion.Current); // "1.0.6"
```
...
| Versión | Hito |
|---------|------|
| `1.0.6` | Fix CS1700 en release, docs Trusted Publishing |
